...
describe('PUT /booking/:bookingId', () => {
    ...
    it('Retorna 404 se o quarto não existe?', async () => {
        ...
        const body = { roomId: room1.id + 99 };
        //const body = { roomId: Number((room2.id + 99)) };
        const roomsNumber = await searchingHowManyRooms((body.roomId + 99));
        //await createBookingWithoutCapacity(user.id, room.id, room.capacity)
